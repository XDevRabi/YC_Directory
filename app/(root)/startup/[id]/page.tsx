        ...
        <div className="space-y-5 mt-10 max-w-4xl mx-auto">
          ...
          {parsedContent ? (
            <article
              ...
              dangerouslySetInnerHTML={{ __html: parsedContent }} // React normally escape html to prevent XSS (cross site scripting) attact rendering the content display text. So when we try to render our html content we need to use dangerouslySetInnerHTML to tell the react the html is safe.
            />
          ) : (
